...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('./customstyling.css')}}" />
</head>
      ...
      <div class="menu-bar v1">
        <div class="container">
          <div class="menu-bar-content">
            <div class="menu-logo">
              <a href="{{ route('/') }}"><img src="https://dropbelaravel.bracketweb.com/assets/images/logo-dark.png"
                  alt="Logo"></a>
            </div>
            <nav class="main-menu">
              <ul>
