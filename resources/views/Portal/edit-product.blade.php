					...
					<form class="custom_form" method="POST" action="{{ route('update-product') }}" id="update_product" name="update_product" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-12 mt-3">
								<button type="submit" id="submit" class="form_btn mt-0 text-center" style="width: 180px;">Update Product</button>
							</div>
...
@section('pagescript')
	...
	<script>
		...
		document.addEventListener('DOMContentLoaded', function () {
			...
			// 🟢 Automatically calculate if values already exist (edit scenario)
