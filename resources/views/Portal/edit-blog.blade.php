	...
	<main id="main" class="main">
		...
		<section class="section">
			<div class="row">
				...
				<div class="col-md-12">
                    @if(!empty($blog))
                        <form class="custom_form" method="POST" action="{{ route('update-blog') }}" id="edit-blog" name="edit-blog" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="" value="{{ $blog->title }}" placeholder="title">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="url" class="form-control" id=""  value="{{ $blog->url }}" placeholder="url">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="blog_image" class="form-control" id="" value={{ $blog->original_file_name }} placeholder="Picture" >
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="image_alt_text" class="form-control" value={{ $blog->image_alt_text }} id="" placeholder="Alt Text">
                                    </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="blog_description" id="message" rows="1" placeholder="Blog Description Here" required>{{ $blog->description }}</textarea>
                                </div>

                                <div class="col-sm-12 mt-3">

                                    <button type="submit" class="form_btn mt-0 text-center" style="width: 180px;">Edit Blog</button>
	    ...
	    <!-- Modal -->
	    <div class="modal fade text-center" id="success_modal_edit_blog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	        <div class="modal-dialog">
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    ...
	                    <p class="my-4">Blog Edit Successfully</p>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            const myModal = new bootstrap.Modal(
                                document.getElementById('success_modal_edit_blog')
                            );
                            myModal.show();
                            $('#success_modal_edit_blog').on('hidden.bs.modal', function () {
                                $('.loader').hide();
