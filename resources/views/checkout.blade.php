...
@section('html')
    ...
    <script src="https://cdn.jsdelivr.net/gh/geodatasource/country-region-dropdown-menu@latest/geodatasource-country-region-dropdown.min.js"></script>
...
@section('script')
    ...
    <script>
        $('ul.list li').on('click', function () {
            ...
            const countryOption = $('#country option').filter(function () {
                return $(this).text() === selectedCountry;
            }).val();
            
            $('#country').val(countryOption).trigger('change');
        });
